      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
            ...
            <Link to="/category/action" className="hover:text-white transition-colors">Action</Link>
            <Link to="/category/horror" className="hover:text-white transition-colors">Horror</Link>
            <Link to="/category/indonesian-movies" className="hover:text-white transition-colors">Indonesia</Link>
            <Link to="/category/indonesian-drama" className="hover:text-white transition-colors">Indo Drama</Link>
